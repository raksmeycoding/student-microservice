...
import org.microservice.studentcourse.dto.CourseResponseDto;
...
public class CourseController {
    ...
    @PostMapping
    public ResponseEntity<CourseResponseDto> postCourse(@RequestBody CourseRequest courseRequest) {
    ...
    @GetMapping("{courseId}")
    public ResponseEntity<CourseResponseDto> getCourseById(@PathVariable UUID courseId) {
